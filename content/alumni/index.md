    ...
    content:
      ...
      text: |
        ...
        <body>
            <div class="profile-grid">
                <div class="profile-item">
                    <img src="image9.png" alt="Ho Jung Yoo">
                    <div class="profile-details">
                        <h3>Ho Jung Yoo</h3>
                        <p><strong>E-mail:</strong> coppy27@g.skku.edu</p>
                        <p><strong>Department:</strong> Artificial Intelligence</p>
                        <p><strong>Degree:</strong> Master (2024.2)</p>
                        <p>LG Electronics</p>
                    </div>
                </div>
                <div class="profile-item">
                    <img src="image10.png" alt="Kwan Hee Han">
                    <div class="profile-details">
                        <h3>Kwan Hee Han</h3>
                        <p><strong>E-mail:</strong> gonahee@g.skku.edu</p>
                        <p><strong>Department:</strong> Digital Media Communication Engineering</p>
                        <p><strong>Degree:</strong> Master (2023.8)</p>
                        <p>Samsung Electronics</p>
                    </div>
                </div>
                <div class="profile-item">
                    <img src="image11.png" alt="Gi Jae Choi">
                    <div class="profile-details">
                        <h3>Gi Jae Choi</h3>
                        <p><strong>E-mail:</strong> chj2106403@g.skku.edu</p>
                        <p><strong>Department:</strong> Artificial Intelligence</p>
                        <p><strong>Degree:</strong> Master (2023.8)</p>
                        <p>Bos Semiconductors</p>
                    </div>
                </div>
                <div class="profile-item">
                    <img src="image12.png" alt="Jae Eun Shim">
                    <div class="profile-details">
                        <h3>Jae Eun Shim</h3>
                        <p><strong>E-mail:</strong> david4466@g.skku.edu</p>
                        <p><strong>Department:</strong> Artificial Intelligence</p>
                        <p><strong>Degree:</strong> Master (2023.2)</p>
                        <p>LG Electronics</p>
                    </div>
                </div>
                <div class="profile-item">
                    <img src="image13.png" alt="Key Heon Lee">
                    <div class="profile-details">
                        <h3>Key Heon Lee</h3>
                        <p><strong>E-mail:</strong> aemincrest@g.skku.edu</p>
                        <p><strong>Department:</strong> Artificial Intelligence</p>
                        <p><strong>Degree:</strong> Master (2023.2)</p>
                        <p>Synopsys</p>
                    </div>
                ...
                <div class="profile-item">
                    <img src="image14.png" alt="Hyun Jo Lim">
                    <div class="profile-details">
                        <h3>Hyun Jo Lim</h3>
                        <p><strong>E-mail:</strong> ejsm456753@g.skku.edu</p>
                        <p><strong>Department:</strong> Artificial Intelligence</p>
                        <p><strong>Degree:</strong> Master (2023.2)</p>
                ...
                <div class="profile-item">
                    <img src="image15.png" alt="Jae Woo Song">
                    <div class="profile-details">
                        <h3>Jae Woo Song</h3>
                        <p><strong>E-mail:</strong> seeking92@gmail.com</p>
                        <p><strong>Department:</strong> Semiconductor Display Engineering</p>
                        <p><strong>Degree:</strong> Master (2023.2)</p>
                        <p>Samsung Display</p>
                    </div>
                </div>
                <div class="profile-item">
                    <img src="image16.png" alt="Sang Min Hyun">
                    <div class="profile-details">
                        <h3>Sang Min Hyun</h3>
                        <p><strong>E-mail:</strong> mymin427@g.skku.edu</p>
                        <p><strong>Research:</strong> Neural Network</p>
                        <p><strong>Degree:</strong> Master (2022.8)</p>
                        <p>Mangoboost</p>
                    </div>
                </div>
                <div class="profile-item">
                    <img src="image17.png" alt="Min Chae Yang">
                    <div class="profile-details">
                        <h3>Min Chae Yang</h3>
                        <p><strong>E-mail:</strong> didalcso6213@skku.edu</p>
                        <p><strong>Research:</strong> Machine Learning, NoC</p>
                        <p><strong>Degree:</strong> Master (2022.2)</p>
                        <p>Samsung Electronics</p>
                    </div>
                </div>
                <div class="profile-item">
                    <img src="image18.png" alt="Hessa Alshamsi">
                    <div class="profile-details">
                        <h3>Hessa Alshamsi</h3>
                        <p><strong>E-mail:</strong> hessa.alshamsi@hotmail.com</p>
                        <p><strong>Research:</strong> SoC, NoC</p>
                        <p><strong>Degree:</strong> Master (2022.2)</p>
                        <p>Samsung Electronics</p>
                    </div>
                </div>
